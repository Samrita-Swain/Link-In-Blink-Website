...
const Hero = () => {
  return (
    <div id='home' className='flex h-[88vh] bg-black bg-cover bg-center mt-[10vh]'
    style={{ backgroundImage: "url('/images/ErrorBoundaryHandler.jpg')" }}>
      ...
      <div className='w-[100%] grid-cols-1 mx-auto grid lg:grid-cols-2 gap-[3rem] h-100% items-center justify-items-center'>
        ...
        <div data-aos='zoom-in' className='w-[500px] bg-[#87289a] relative lg:flex items-center rounded-full h-[500px]'>
